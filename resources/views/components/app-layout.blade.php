...
<head>
    ...
    {{-- Prevent mixed content issues on HTTPS hosting --}}
    ...
    <div class="min-h-screen flex transition-all duration-300" x-data="{ sidebarOpen: true }">
        ...
        >
            ...
            <nav class="mt-6 px-0 space-y-1">
                ...
                <a href="{{ route('recaps.index') }}" class="nav-link {{ request()->routeIs('recaps.*') ? 'active' : '' }} group flex items-center px-8 py-3.5 text-sm font-semibold text-slate-600 transition-colors">
                    <svg class="mr-3 h-5 w-5 {{ request()->routeIs('recaps.*') ? 'text-blue-600' : 'text-slate-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                    Rekap Bulanan
                </a>
